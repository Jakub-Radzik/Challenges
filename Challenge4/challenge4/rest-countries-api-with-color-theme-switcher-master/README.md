...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](rest-countries-api-with-color-theme-switcher-master/README-template.md) file in this starter code.
